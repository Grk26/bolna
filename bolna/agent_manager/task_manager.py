...
class TaskManager(BaseManager):
    ...
    async def load_prompt(self, assistant_name, task_id, local, **kwargs):
        ...
        self.is_local = local
        if task_id == 0:
            if self.context_data!=None and 'recipient_data' in self.context_data and self.context_data['recipient_data'] and self.context_data['recipient_data'].get('timezone', None):
